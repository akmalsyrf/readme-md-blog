---
title: 'Newton’s Law of Inertia in Everyday Life: From Rest to Motion'
description: 'How the physics principle “at rest stays at rest, in motion stays in motion” explains our inertia—and why the first step is the key to breaking it.'
pubDate: 2026-02-08
author: 'Akmal'
...
<div style="display: flex; flex-direction: column; align-items: center; margin: 2rem 0;">
  <picture style="display: block;">
    <source srcset="/notes/20260208185635_newtons-inertia-law-in-daily-life/lazy-meme.webp" type="image/webp">
    <img 
      src="/notes/20260208185635_newtons-inertia-law-in-daily-life/lazy-meme.png" 
      alt="Inertia at rest" 
      width="500"
      loading="lazy"
      decoding="async"
...
<div style="display: flex; flex-direction: column; align-items: center; margin: 2rem 0;">
  <picture style="display: block;">
    <source srcset="/notes/20260208185635_newtons-inertia-law-in-daily-life/inertia.webp" type="image/webp">
    <img 
      src="/notes/20260208185635_newtons-inertia-law-in-daily-life/inertia.png" 
      alt="Law of inertia" 
      width="500"
      loading="lazy"
      decoding="async"
...
There’s a saying we often hear: _“A journey of a thousand miles begins with a single step.”_ It’s not just motivation—it’s an accurate description of how inertia and momentum work.
...
<div style="display: flex; flex-direction: column; align-items: center; margin: 2rem 0;">
  <picture style="display: block;">
    <source srcset="/notes/20260208185635_newtons-inertia-law-in-daily-life/image.webp" type="image/webp">
    <img 
      src="/notes/20260208185635_newtons-inertia-law-in-daily-life/image.png" 
      alt="Start with a small (fundamental) step—unlike in the picture where they force a jump that’s way too far :D" 
      width="500"
      loading="lazy"
      decoding="async"
      style="display: block; margin: 0 auto; max-width: 100%; height: auto;"
  ...
  <p style="text-align: center; margin-top: 0.5rem; margin-bottom: 0;">
    <em>Start with a small (fundamental) step—unlike in the picture where they force a jump that’s way too far :D</em>
  </p>
</div>
...
1. **Start small.** Don’t aim for a big change first. Pick one simple task that still moves you toward your goal and do it. A small force is still a force—enough to shift the state from “rest” to “motion.”

2. **Build a routine.** Routine is a scheduled “external force.” With fixed times for exercise, writing, or study, you rely less on mood. The schedule is what pushes you to move, even when it feels heavy at first.

3. **Accept that momentum is real.** Once you’ve started, keep going a bit more. Often the strongest resistance is _before_ the first step. After starting, many people find it easier to continue.

4. **Reward yourself.** Linking a positive action to something enjoyable (a coffee, a short break, an episode of a show) can make the “force” to start stronger next time.

5. **Don’t be too hard on yourself.** Sometimes we’re just tired or not in the mood. Inertia is normal. What matters isn’t punishing yourself, but noticing the pattern: when we tend to stay at rest, and which small action most often gets us moving.
