export default {
  ...
  about: {
    title: 'Tentang Saya',
    description:
      'Software engineer dari Indonesia. Saya menulis catatan tentang teknologi, pengembangan perangkat lunak, dan hal-hal menarik lainnya.',
    bio: 'Siapa Saya',
    experience: 'Pengalaman',
    experienceItems: [
      'Membangun API dan layanan backend dengan Go dan ekosistem cloud-native',
      'Eksperimen dengan AI, machine learning, dan RAG untuk aplikasi praktis',
      'Menulis catatan teknis dan studi kasus dari proyek nyata di GitHub',
    ],
    skills: 'Keahlian',
    skillsItems: [
      'Go',
    ...
    contact: 'Kontak',
    portfolio: 'Portfolio',
    portfolioCta: 'Kunjungi portfolio saya di akmalsyrf.is-a.dev',
    notes: 'Catatan',
    notesCta: 'Baca catatan dan artikel teknis saya',
  },
  notes: {
    title: 'Catatan',
