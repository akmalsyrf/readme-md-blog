export default {
  ...
  about: {
    title: 'About Me',
    description:
      'Software engineer from Indonesia. I write notes about technology, software development, and other interesting topics.',
    bio: 'Who I Am',
    experience: 'Experience',
    experienceItems: [
      'Building APIs and backend services with Go and cloud-native ecosystems',
      'Experimenting with AI, machine learning, and RAG for practical applications',
      'Writing technical notes and case studies from real projects on GitHub',
    ],
    skills: 'Skills',
    skillsItems: [
      'Go',
    ...
    contact: 'Contact',
    portfolio: 'Portfolio',
    portfolioCta: 'Visit my portfolio at akmalsyrf.is-a.dev',
    notes: 'Notes',
    notesCta: 'Read my technical notes and articles',
  },
  notes: {
    title: 'Notes',
    readMore: 'Read more',
  ...
  pph21Calculator: {
    ...
    modeNetToGross: 'Net → Gross (Real Burden)',
    modeTaxToGross: 'Tax → Gross (Reverse)',
    monthlyGrossLabel: 'Monthly Gross Salary',
    monthlyNetLabel: 'Monthly Net Salary',
    thrLabel: 'THR (Holiday Allowance)',
    yearlyBonusLabel: 'Yearly Bonus (Optional)',
    maritalStatusLabel: 'PTKP Status',
    applyBiayaJabatanLabel: 'Apply biaya jabatan',
    applyBiayaJabatanTooltip: {
      title: 'Who gets biaya jabatan?',
      description:
    ...
    taxTierDetailTitle: 'Annual tax breakdown (by tier)',
    taxTierLabel: 'Tier {tier} ({rate}% × Rp {amount})',
    totalAnnualTax: 'Total Annual PPh 21',
    maritalStatusOptions: {
      TK0: 'TK/0 (Single, 0 Dep)',
      TK1: 'TK/1 (Single, 1 Dep)',
      TK2: 'TK/2 (Single, 2 Dep)',
      TK3: 'TK/3 (Single, 3 Dep)',
      K0: 'K/0 (Married, 0 Dep)',
      K1: 'K/1 (Married, 1 Dep)',
      K2: 'K/2 (Married, 2 Dep)',
      K3: 'K/3 (Married, 3 Dep)',
    },
    calculateButton: 'Calculate',
    resetButton: 'Reset',
    inputTitle: 'Input',
    resultsTitle: 'Calculation Results',
    yearlyGross: 'Yearly Gross Income',
    biayaJabatan: 'Biaya Jabatan (5%, max Rp 6M/year)',
    ptkp: 'PTKP',
    pkp: 'Taxable Income (PKP)',
    pphYearly: 'Annual PPh 21',
    pphMonthly: 'Monthly PPh 21 (average)',
    takeHomeMonthly: 'Monthly Take Home',
    takeHomeYearly: 'Yearly Take Home',
    requiredGrossMonthly: 'Required Monthly Gross',
    requiredGrossYearly: 'Required Yearly Gross',
    invalidInput: 'Please enter valid values (numbers ≥ 0).',
    tooltips: {
      yearlyGross: {
        title: 'Yearly Gross Income',
        description: 'Total gross income in a year before any deductions.',
        formula: 'Monthly salary × 12 + THR + Yearly bonus',
        explanation: 'Base for PPh 21 and deductions (biaya jabatan, PTKP).',
      },
      biayaJabatan: {
        title: 'Biaya Jabatan',
        description: 'Deduction from gross for employees; max 5% of gross or Rp 6M/year.',
        formula: 'min(5% × Yearly gross, Rp 6,000,000)',
        explanation: 'Per regulation; reduces taxable income.',
      },
      ptkp: {
        title: 'PTKP',
        description: 'Non-taxable income threshold by status (single/married and dependants).',
        formula: 'By status (TK/0–K/3)',
        explanation: 'Annual amount; income below this is not taxed.',
      },
      pkp: {
        title: 'Taxable Income (PKP)',
        description: 'Tax base after biaya jabatan and PTKP.',
        formula: 'Yearly gross − Biaya jabatan − PTKP (min 0)',
        explanation: 'PKP is subject to progressive rates (Article 17).',
      },
      pphYearly: {
        title: 'Annual PPh 21',
        description: 'Total income tax due for the year.',
        formula: 'Progressive 5%–35% × PKP layers',
        explanation: 'Withheld by employer or paid personally (per rules).',
      },
      pphMonthly: {
        title: 'Monthly PPh 21 (average)',
        description: 'Annual tax divided by 12 for estimated monthly withholding.',
        formula: 'Annual PPh 21 ÷ 12',
        explanation: 'Simplified; actual withholding may vary by month.',
      },
      takeHomeMonthly: {
        title: 'Monthly Take Home',
        description: 'Net pay per month after PPh 21.',
        formula: '(Yearly gross − Annual PPh 21) ÷ 12',
        explanation: 'Estimate; excludes other deductions (BPJS, pension, etc.).',
      },
      requiredGrossMonthly: {
        title: 'Required Monthly Gross',
        description: 'Estimated monthly gross (excluding THR/bonus) to achieve target net.',
        formula: '(Total yearly gross − THR − Bonus) ÷ 12',
        explanation: 'From Net→Gross mode so take home equals desired net.',
      },
    },
  },
  hppCalculator: {
